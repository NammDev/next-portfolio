          ...
          <div className='flex flex-col max-w-3xl space-y-16'>
            <article className='md:grid md:grid-cols-4 md:items-baseline'>
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  State-driven user interfaces with Svelte &amp; XState. Learn how to define a state
                  machine and how to use it in your Svelte components.
                </p>{' '}
                <div
                  aria-hidden='true'
            ...
            <article className='md:grid md:grid-cols-4 md:items-baseline'>
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  Today, I am excited to announce a hands-on, live, project-based course with a
                  small, highly motivated group of professional software engineers.
                </p>{' '}
                <div
                  aria-hidden='true'
                  className='relative z-10 flex items-center mt-4 text-sm font-medium text-teal-500'
            ...
            <article className='md:grid md:grid-cols-4 md:items-baseline'>
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  At some point, your SvelteKit app needs to persist data. Learn how to use Prisma
              ...
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                  ...
                  <a href='/blog/why-i-left-google-and-joined-gitpod'>
                    <span className='absolute z-20 -inset-y-6 -inset-x-4 sm:-inset-x-6 sm:rounded-2xl' />
                    <span className='relative z-10'> Why I Left Google and Joined Gitpod</span>
                  </a>
                </h2>{' '}
                <time
                  className='md:hidden relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5'
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  A short summary of my time at Google, 2020, and what convinced me to go back to
                  the startup world.
                </p>{' '}
                <div
                  aria-hidden='true'
              ...
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                  ...
                  <a href='/blog/a-svelte-component-to-format-numbers'>
                    <span className='absolute z-20 -inset-y-6 -inset-x-4 sm:-inset-x-6 sm:rounded-2xl' />
                    <span className='relative z-10'> A Svelte component to format numbers</span>
                  </a>
                </h2>{' '}
                <time
                  className='md:hidden relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5'
              ...
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                  ...
                  <a href='/blog/2021-my-objectives-key-results'>
                    <span className='absolute z-20 -inset-y-6 -inset-x-4 sm:-inset-x-6 sm:rounded-2xl' />
                    <span className='relative z-10'> 2021 - My Objectives &amp; Key Results</span>
                  </a>
                </h2>{' '}
                <time
                  className='md:hidden relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5'
            ...
            <article className='md:grid md:grid-cols-4 md:items-baseline'>
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  Do you want to earn a six figure income, work from anywhere, live a lifestyle of
                  your choosing and be a part of the people who develop the next generation software
                  applications? Are you a software engineer already, but want to change jobs or
                  advance in your current role to get promoted?
                </p>{' '}
                <div
                  aria-hidden='true'
                  className='relative z-10 flex items-center mt-4 text-sm font-medium text-teal-500'
              ...
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                  ...
                  <a href='/blog/why-i-turned-my-homepage-into-a-timeline'>
                    <span className='absolute z-20 -inset-y-6 -inset-x-4 sm:-inset-x-6 sm:rounded-2xl' />
                    <span className='relative z-10'> Why I turned my homepage into a timeline</span>
                  </a>
                </h2>{' '}
                <time
                  className='md:hidden relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5'
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  A short explanation of why I streamlined the homepage into a timeline showcasing
                  my blog posts, Twitter stats, YouTube videos, and projects.
                </p>{' '}
                <div
                  aria-hidden='true'
                  className='relative z-10 flex items-center mt-4 text-sm font-medium text-teal-500'
              ...
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                  ...
                  <a href='/blog/how-i-wrote-214-pages-for-a-web-development-book-with-19-pull-requests-in-3-months'>
                    ...
                    <span className='relative z-10'>
                      {' '}
                      How I wrote 214 pages for a web development book with 19 pull requests in 3
                      months
                    </span>
                  </a>
                </h2>{' '}
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  An in-depth journey report of the last three months when I wrote the Cloud Native
                  Web Development book. Why did I write it? How did I develop the source code? Why
            ...
            <article className='md:grid md:grid-cols-4 md:items-baseline'>
              <div className='relative flex flex-col items-start md:col-span-3 group'>
                ...
                <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                  A complete rewrite of my personal website and blog with Svelte, Sapper, mdsvex and
                  Tailwind CSS. Blog posts can be reviewed on a preview URL and discussed in a pull
                  request. The site follows best practices; accessibility (a11y), top Lighthouse
                  score, Google's web vitals, and SEO.
                </p>{' '}
                <div
                  aria-hidden='true'
                  className='relative z-10 flex items-center mt-4 text-sm font-medium text-teal-500'
